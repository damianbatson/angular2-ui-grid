...
export function initAngularjs() {
  ...
  const ng1Component: angular.IComponentOptions = {
    ...
    template: '<div ui-grid="gridOptions" ui-grid-grouping ui-grid-edit ui-grid-selection class="grid" style="width:100%;"></div> {{msg.lastCellEdited}}'
  };
  ...
  const ng1Component2: angular.IComponentOptions = {
    ...
    template: '<div ui-grid="gridOptions" ui-grid-grouping ui-grid-edit ui-grid-selection class="grid" style="width:100%;"></div>'
  };
